...
ActiveRecord::Schema.define(version: 20161025212152) do
  ...
  create_table "listings", force: :cascade do |t|
    ...
    t.string   "image_url",       default: "http://i.imgur.com/00aovFw.jpg"
  ...
  create_table "trips", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["listing_id"], name: "index_trips_on_listing_id", using: :btree
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "api_key",           default: "771b56a7ab0a5d1e62d98765816fc504"
  end
