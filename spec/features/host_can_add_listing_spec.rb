...
RSpec.feature "Host creates listing" do
  ...
  scenario "host cannot create listing if not all the params are given" do
    # As a Host
    login_as_host
    # When I click "Listings"
    click_link "Listings"
  ...
  scenario "host cannot create listing if start date is higher than end date" do
    # As a Host
    login_as_host
    # When I click "Listings"
    click_link "Listings"
    ...
    select "2016-11-01", from: "listing_end_date"
